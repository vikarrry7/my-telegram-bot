...
RUSSIAN_DESCRIPTIONS = {
    'hamster': """Хомяк — небольшое млекопитающее из подсемейства хомяковых. Известны своими защечными мешками, в которых переносят пищу. Популярны в качестве домашних питомцев. Наиболее распространенный вид —
 сирийский хомяк. Активны в основном ночью.""",
    'hedgehog': """Ёжик (лат. Erinaceus) — млекопитающее из семейства ежовых. Известны своими иголки, которые на самом деле являются видоизмененными волосами. Питаются насекомыми, червями, иногда мелкими позво
ночными и фруктами. Активны в основном ночью, на зиму впадают в спячку.""",
    'dog': """Собака (лат. Canis lupus familiaris) — домашнее животное, одно из наиболее популярных животных-компаньонов. Первое одомашненное животное, был одомашнен примерно 15 000 лет назад. Существует множе
ство пород собак, которые различаются по размерам, масти, сложению и поведению.""",
    'cat': """Кошка (лат. Felis catus) — домашнее животное, одно из наиболее популярных «животных-компаньонов». Была одомашнена около 10 000 лет назад на Ближнем Востоке. Кошки являются хищниками и сохранили м
ногие черты своих диких предков.""",
    'elephant': """Слон — самое крупное современное наземное животное. Отличается хоботом, бивнями и большими ушами. Существует три вида слонов: африканский саванный слон, африканский лесной слон и азиатский с
лон. Слоны живут семейными группами во главе со старшей самкой.""",
    'dolphin': """Дельфины — морские млекопи��ающие из отряда китообразных. Известны своим высоким интеллектом, игривым поведением и способностью к эхолокации. Спят дельфины особым образом: у них спит только о
дно полушарие мозга, чтобы они могли продолжать дышать и контролировать свое положение в воде.""",
    'lion': """Лев (лат. Panthera leo) — хищное млекопитающее рода пантер. Второй по величине после тигра представитель семейства кошачьих в мире. Единственные кошачьи, живущие в прайдах. Самцы отличаются грив
ой.""",
...
""",
    'mammal': """Млекопитающие — класс позвоночных животных, основной отличительной особенностью которых является вскармливание детёнышей молоком. Другие характерные черты: волосяной покров, теплокровность, на
личие диафрагмы и развитой коры головного мозга.""",
    'artificial intelligence': """Искусственный интеллект (ИИ) — это технология создания компьютерных систем, способных выполнять задачи, требующие человеческого интеллекта: распознавание образов, принятие реш
ений, обучение, понимание естественного языка. ИИ используется в медицине, транспорте, финансах и многих других областях.""",
    'question mark': """Вопросительный знак (?) — знак препинания, ставится обычно в конце предложения для выражения вопроса или сомнения. Встречается в печатных книгах с XVI века, однако для выражения вопроса
 он закрепляется значительно позже, лишь в XVIII веке.""",
}
...
def search_wikipedia(query, lang='en'):
    ...
    try:
        ...
        if query == "dolphin sleep":
            if lang == 'ru':
              return "Дельфины спят особым образом: у них спит только одно полушарие мозга, а второе бодрствует. Это позволяет им продолжать дышать и контролировать свое положение в воде. Такой сон называетс
я однополушарным медленноволновым сном."
            else:
                return "Dolphins sleep with only one brain hemisphere at a time in slow-wave sleep. The other hemisphere remains awake to allow them to continue breathing and maintain awareness of their enviro
nment."
        
        if query.startswith("specific:"):
            animal = query.split(":")[1]
            if animal == "mammal":
                return "По фото видно, что это млекопитающее. Для определения точного вида нужны более детальные признаки. Млекопитающие отличаются наличием шерсти, вскармливанием детенышей молоком и теплокров
ностью."
...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    • Распознавать объек��ы на фотографиях
